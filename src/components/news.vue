        ...
        <Row>
            ...
            <Col span="21">
                <div class="btns">
                    ...
                    <Button type="info" @click="addData" style="marginLeft: 10px" class="btn1">添加数据</Button>
                    <Button type="error" @click="removes" style="marginLeft: 10px" class="btn2">删除数据</Button>
                </div>
