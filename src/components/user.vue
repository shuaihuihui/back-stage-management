<template>
	<div>
		...
		<div class="btns">
	    	...
	    	<Button type="primary" @click="addData" style="margin-left:5px" class="btn1">添加用户</Button>
			<Button type="error" @click="removes" style="margin-left:5px" class="btn2" >删除选择</Button>
		</div>	
